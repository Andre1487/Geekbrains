""" Андре септиянто -  Создайте собственный класс-исключение, который должен проверять содержимое списка на наличие только чисел.
...
элемента необходимо реализовать проверку типа элемента и вносить его в список, только если введено число. Класс-исключение должен
...
if __name__ == '__main__':
    ...
    while True:
        user_input = input("input number for list or type in 'stop' for exit: ")
        ...
        try:
            if not user_input.isdigit():
                raise NotNumberError(f"'{user_input}' is not numerical format")
