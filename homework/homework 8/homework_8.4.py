"""Андре септиянто - Начните работу над проектом «Склад оргтехники». Создайте класс, описывающий склад.
...
class OfficeEquipment:
    ...
    def __init__(self, eq_type: str, vendor: str, model: str, color: str, purchase_price: float,):
        self.type = eq_type
        self.vendor = vendor
        self.model = model
        self.color = color
...
class Xerox(OfficeEquipment):
    ...
    def __init__(self, *args):
        super().__init__('photocopy', *args)


if __name__ == '__main__':
    p1 = Printer("xerox", "phaser-3020", "white", 4000)
    print(p1)
    p2 = Scanner("epson", "scx-233", "black", 3000)
    print(p2)
    p3 = Xerox("HP", "cp-211", "grey", 6000)
    print(p3)